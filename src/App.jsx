  ...
  const [job, setCurrentJob] = useState([
    ...
    const [projects, setProjects] = useState([
        ...
        const [skills, setSkills] = useState(
        {
            ...
            developerTools: "Git, Docker, TravisCI, Google Cloud Platform, VS Code, Visual Studio, PyCharm",
    ...
    <>
      ...
      {buttonClicked ? (
        <div className="main-container">
          <InfoSection personalInfo = {personalInfo} setPersonalInfo={setPersonalInfo} education={education} setCurrentEducation={setCurrentEducation} job={job} setCurrentJob={setCurrentJob} projects={projects} setProjects={setProjects} skills={skills} setSkills={setSkills}/>
          <ResumeSection personalInfo = {personalInfo} education={education} job={job} projects={projects} skills={skills} />
        </div>
      ) : (
